...
public class GradeChartCategoryDataset extends AbstractDataset implements CategoryDataset {
    // Row -> Activity
    // Column -> Date
    // Cross -> grade
    ...
    public GradeChartCategoryDataset(LocalDate startDate, LocalDate endDate, Map<String, Map<LocalDate, Optional<Integer>>> grades) {
