package pl.szafraniec.ChildrenMotivator.ui.activities.tableSchemes.dialog;
...
public class EditActivitiesTableSchemeDialog extends Dialog {
    ...
    public EditActivitiesTableSchemeDialog(Shell shell) {
        this(shell, "", new ArrayList<>(), "Dodaj schemat");
    }
